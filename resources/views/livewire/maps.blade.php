<div class="px-4 sm:px-6 lg:px-8">
    ...
    @if ($editing)
        <div class="mt-6 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-gray-900">
            <h2 class="mb-4 text-sm font-semibold text-gray-900 dark:text-white">Editing: {{ $editing }}</h2>
                ...
                <div x-data>
                    ...
                    <div class="mt-1 flex flex-wrap gap-2">
                        @forelse ($form['filters'] as $filter)
                            <span class="inline-flex items-center gap-1 rounded-md bg-gray-100 px-2 py-1 text-xs text-gray-900 dark:bg-white/10 dark:text-gray-100">
                                {{ $filter }}
                    ...
                    @if ($form['game'])
                        ...
                        <div class="mt-1 flex flex-wrap gap-2">
                            @forelse($suggestions as $s)
                                <button
                                    type="button"
                                    wire:click="$set('filterInput','{{ $s }}'); addFilter()"
                    ...
                    <tr>
                        <td class="w-full max-w-0 py-4 pr-3 pl-4 text-sm font-medium text-gray-900 sm:w-auto sm:max-w-none sm:pl-0 dark:text-white">
                            ...
                            <dl class="font-normal lg:hidden">
                                ...
                                <dd class="mt-1 truncate text-gray-700 dark:text-gray-300">{{ implode(', ', $map['games']) }}</dd>
                        ...
                        <td class="hidden px-3 py-4 text-sm text-gray-500 lg:table-cell dark:text-gray-400">{{ implode(', ', $map['games']) }}</td>
